...
(always-within 0.006 (<= (fuel plane1) (* 0.5 (capacity plane1))) (= (fuel plane1) (capacity plane1)))
(always-within 0.006 (<= (fuel plane2) (* 0.5 (capacity plane2))) (= (fuel plane2) (capacity plane2)))
(always-within 0.006 (<= (fuel plane3) (* 0.5 (capacity plane3))) (= (fuel plane3) (capacity plane3)))
(always-within 0.006 (<= (fuel plane4) (* 0.5 (capacity plane4))) (= (fuel plane4) (capacity plane4)))
(always-within 0.006 (<= (fuel plane5) (* 0.5 (capacity plane5))) (= (fuel plane5) (capacity plane5)))))
