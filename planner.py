...
def planner(problem_name, plan_mode=PlanMode.DEFAULT, hide_plan=False):
...
def main(problem_name, files, planning_mode, domain_path, problem_path, hide_plan):    
    ...
    planner(problem_name, plan_mode=planning_mode, hide_plan=hide_plan)
