...
problems = {
    ...
    'ZenoTravel13': [    
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/ZenoTravel-no-constraintdomain_with_n.pddl',
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/ZenoTravel-no-constraint/pfile13.pddl',
        ['distance', 'slow-burn', 'fast-burn', 'capacity', 'zoom-limit'],
        initializeHumanConstraintsZenotravel13,
    ],
    'ZenoTravel7': [    
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/ZenoTravel-no-constraintdomain_with_n.pddl',
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/ZenoTravel-no-constraint/pfile7.pddl',
        ['distance', 'slow-burn', 'fast-burn', 'capacity', 'zoom-limit'],
        initializeHumanConstraintsZenotravel7,
    ],
    'ZenoTravel10': [    
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/ZenoTravel-no-constraintdomain_with_n.pddl',
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/ZenoTravel-no-constraint/pfile10.pddl',
        ['distance', 'slow-burn', 'fast-burn', 'capacity', 'zoom-limit'],
        initializeHumanConstraintsZenotravel10,
    ],
    'Rover13': [
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/domain.pddl',
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/pfile13.pddl',
    ...
    # Comment: Can't find a valid in within 15min, neither using anytime or sat-hmrph. But can find a 55 long solution with just 5 TO and random constraints
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/domain_n.pddl',
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/pfile8.pddl',
        ['in', 'empty', 'have_rock_analysis', 'have_soil_analysis', 'full', 'calibrated', 'available', 'have_image', 'communicated_soil_data', 'communicated_rock_data', 'communicated_image_data', 'energy', 'recharges'],
        initializeHumanConstraintsRover8n,
    ],
    'Rover8_n_t': [
    # Comment: Can't find a valid in within 15min, neither using anytime or sat-hmrph. But can find a 55 long solution with just 5 TO and random constraints
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/domain_n_t.pddl',
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/pfile8_t.pddl',
        ['in', 'empty', 'have_rock_analysis', 'have_soil_analysis', 'full', 'calibrated', 'available', 'have_image', 'communicated_soil_data', 'communicated_rock_data', 'communicated_image_data', 'energy', 'recharges'],
    ...
    # Comment: Can't find a valid in within 15min, neither using anytime or sat-hmrph. But can find a 55 long solution with just 5 TO and random constraints
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/domain_n_t.pddl',
        '/home/afavier/ws/CAI/PDDL_problems/NTCORE/Rover-Numeric/pfile10_t.pddl',
        ['in', 'empty', 'have_rock_analysis', 'have_soil_analysis', 'full', 'calibrated', 'available', 'have_image', 'communicated_soil_data', 'communicated_rock_data', 'communicated_image_data', 'energy', 'recharges'],
